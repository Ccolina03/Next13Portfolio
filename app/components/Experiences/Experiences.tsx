        ...
        <div id="work-experience1" className='flex flex-col gap-y-16 items-center md:items-center sm:items-end xs:items-end'>
            ...
            <div className='experience-container flex justify-center'>
                <div className='timeline w-28 bg-backgroundWork flex flex-col items-center'>
                    ...
                    bullet2='Implemented FastAPI endpoints to perform automated processes using Redis and Celery tasks, leading to 60% decrease in manual work'
                    bullet3='Developing a prototype project to synchronize computed spatial data between PostgreSQL and ElasticSearch, enabling side-by-side views and logical updates'/>
